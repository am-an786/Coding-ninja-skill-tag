...
minute.addEventListener("input", ()=>{
    minute.value = inputCheck(minute.value);
});
...
setAlarm.addEventListener("click",() => {
     ...
     let alarmObj ={};
     alarmObj.id = `${alarmIndex}_${hour.value}_${minute.value}`;
     ...
     hour.value =appendZero(inititialHour);
     minute.value =appendZero(initialMinute);
